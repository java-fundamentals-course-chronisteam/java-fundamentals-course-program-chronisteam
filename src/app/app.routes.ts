...
const courseList = () => import('./learning/presentation/views/course-list/course-list').then(m => m.CourseList);
const categoryList = () => import('./learning/presentation/views/category-list/category-list').then(m => m.CategoryList);
